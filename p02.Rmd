...
plot(df_scales_subset , pch=20 , cex=1.5 , col="#69b3a2")
#https://r-graph-gallery.com/98-basic-scatterplot-matrix.html
...
```
Also going to play with this, from:https://r-graph-gallery.com/201-levelplot-with-latticeextra.html

This is pretty but really tells us nothing. 
```{r}
#play around and try to figure out what this all means and how to apply it to my own stuff 
# library
library(latticeExtra) 
# showing data points on the same color scale 
levelplot(FNEscale ~ RSEscale * SCscale, df_3numvar, 
          panel = panel.levelplot.points, cex = 1.2
    ) + 
    layer_(panel.2dsmoother(..., n = 200)) 
     #  x="Self-Esteem",
      # y= "Self-Control")
#adding the labels is throwing NULL for some reason 
  #this is pretty but it isn't really telling me anything, not tremendously interpretable
