...
library(visdat)
library(corrr)
Data <- read_sav("~/Documents/TA/OnlinePsychologySurveyData.sav")
...
#this is very cool and it makes sense - self esteem looks quite unrelated to fear of negative evaluation 
