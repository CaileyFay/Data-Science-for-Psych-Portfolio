...
ggplot(results_long, mapping=aes(x=value, fill=Estimate)) + 
  ...
  labs(title="Distribution of A,C,E Estimates Across 9 Iterations",
       ...
       fill="Parameter")
```
These values aren't even close, but I am going to leave it as is for now. Something definitely went wrong and the problem is either with Hermine's script or EasyMx's, or in the way that I pulled out the standardized parameters. Major cause for concern. 
